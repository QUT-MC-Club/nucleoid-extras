...
public final class NucleoidSidebar {
    ...
    private static final Style MAIN_TITLE_STYLE = Style.EMPTY.withColor(0x0066B9).withBold(true);
    private static final Style FLASH_TITLE_STYLE = Style.EMPTY.withColor(0xffffff);
    private static final Style ALT_TITLE_STYLE = Style.EMPTY.withColor(0x009DE0).withBold(true);
